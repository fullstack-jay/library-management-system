...
import { KategoriBuku, CreateKategoriRequest } from '@/types';
...
export default function AdminKategoriPage() {
  ...
  const [selectedKategori, setSelectedKategori] = useState<KategoriBuku | null>(null);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (selectedKategori) {
        // Update existing kategori - id is now in request body
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="mt-2 text-gray-600">Kelola kategori buku perpustakaan</p>
        </div>
